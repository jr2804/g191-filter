...
| ---------------------- | --------------------------------------------------------------- | ----------------------------------------------- |
| Package source root    | `src/g191_filter/`  | `__init__.py`, `__about__.py` (version)         |
| CLI entry points       | `src/g191_filter/cli/`            | `app.py` (Typer app), `args.py`, `commands.py`  |
