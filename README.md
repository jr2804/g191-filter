...
```bash
uv run g191_filter                  # default command
uv run g191_filter greet Alice      # greet someone
uv run g191_filter add 5 3          # add numbers
uv run g191_filter --version        # show version
```

| Environment Variable | Description |
|----------------------|-------------|
| `G191_FILTER_CACHE` | Enable/disable caching (true/false) |
| `G191_FILTER_OUTPUT_FILE` | Default output file path |
...
├── src/g191_filter/     # Source package
│   ├── __init__.py
│   ├── __about__.py
│   └── cli/
│       ├── __init__.py
